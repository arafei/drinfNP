...
write.csv(res1, paste0("res1_TT_glm_BS_", n0, "_", n1, "_", rho, "_", lambda, "_1.csv"), col.names=T, sep=T)
...
write.csv(tb, paste0("tb_TT_glm_BS_", n0, "_", n1, "_", rho, "_", lambda, "_1.csv"), col.names=T, sep=",")
