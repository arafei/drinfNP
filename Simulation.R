...
#rm(list=ls())
setwd("C:\\Users\\arafei\\Desktop\\Paper2\\TT - D - final")
...
#gamma1 <- rtexp1(+0.4*pop$X1-0.3*pop$X12+0.2*pop$X2+0.1*pop$X1X2)

#pop$pi0 <- exp(gamma0+0.5*pop$D)/(1+exp(gamma0+0.5*pop$D))
#pop$pi1 <- exp(gamma1+0.4*pop$X1-0.3*pop$X12+0.2*pop$X2+0.1*pop$X1X2)/(1+exp(gamma1+0.4*pop$X1-0.3*pop$X12+0.2*pop$X2+0.1*pop$X1X2))
#summary(pop$pi0)
#summary(pop$pi1)
...
for(i in 129:nSim){
	...
	out10 <- cal_bs(psmp=smp0[, c("X1", "X2", "X12", "X13", "D", "X1X2", "wght")], nsmp=smp1[, c("X1", "X2", "X12", "X13", "D", "X1X2", "Y1", "wght0")], method=c("PSDO0", "PSDO1", "IPSWC", "IPSW", "OR", "AIPW", "PSPP"), spec=c(T, T), model="GLM", Npop=N, BS=T, nBS=nBS, trim=c("no"))
	out11 <- cal_bs(psmp=smp0[, c("X1", "X2", "X12", "X13", "D", "X1X2", "wght")], nsmp=smp1[, c("X1", "X2", "X12", "X13", "D", "X1X2", "Y1", "wght0")], method=c("PSDO0", "PSDO1", "IPSWC", "IPSW", "OR", "AIPW", "PSPP"), spec=c(T, F), model="GLM", Npop=N, BS=T, nBS=nBS, trim=c("no"))
	out12 <- cal_bs(psmp=smp0[, c("X1", "X2", "X12", "X13", "D", "X1X2", "wght")], nsmp=smp1[, c("X1", "X2", "X12", "X13", "D", "X1X2", "Y1", "wght0")], method=c("PSDO0", "PSDO1", "IPSWC", "IPSW", "OR", "AIPW", "PSPP"), spec=c(F, T), model="GLM", Npop=N, BS=T, nBS=nBS, trim=c("no"))
	out13 <- cal_bs(psmp=smp0[, c("X1", "X2", "X12", "X13", "D", "X1X2", "wght")], nsmp=smp1[, c("X1", "X2", "X12", "X13", "D", "X1X2", "Y1", "wght0")], method=c("PSDO0", "PSDO1", "IPSWC", "IPSW", "OR", "AIPW", "PSPP"), spec=c(F, F), model="GLM", Npop=N, BS=T, nBS=nBS, trim=c("no"))
	#out14 <- cal_bs(psmp=smp0[, c("X1", "X2", "X12", "X13", "D", "X1X2", "wght")], nsmp=smp1[, c("X1", "X2", "X12", "X13", "D", "X1X2", "Y1", "wght0")], method=c("PSDO0", "PSDO1", "IPSWC", "IPSW", "OR", "AIPW", "PSPP"), spec=c(F, F), model="BART", Npop=N, BS=T, nBS=nBS, nMCMC=nMC, trim=c("no"))
	out20 <- cal_bs(psmp=smp0[, c("X1", "X2", "X12", "X13", "D", "X1X2", "wght")], nsmp=smp1[, c("X1", "X2", "X12", "X13", "D", "X1X2", "Y2", "wght0")], method=c("PSDO0", "PSDO1", "IPSWC", "IPSW", "OR", "AIPW", "PSPP"), spec=c(T, T), model="GLM", Npop=N, BS=T, nBS=nBS, trim=c("no"))
	out21 <- cal_bs(psmp=smp0[, c("X1", "X2", "X12", "X13", "D", "X1X2", "wght")], nsmp=smp1[, c("X1", "X2", "X12", "X13", "D", "X1X2", "Y2", "wght0")], method=c("PSDO0", "PSDO1", "IPSWC", "IPSW", "OR", "AIPW", "PSPP"), spec=c(T, F), model="GLM", Npop=N, BS=T, nBS=nBS, trim=c("no"))
	out22 <- cal_bs(psmp=smp0[, c("X1", "X2", "X12", "X13", "D", "X1X2", "wght")], nsmp=smp1[, c("X1", "X2", "X12", "X13", "D", "X1X2", "Y2", "wght0")], method=c("PSDO0", "PSDO1", "IPSWC", "IPSW", "OR", "AIPW", "PSPP"), spec=c(F, T), model="GLM", Npop=N, BS=T, nBS=nBS, trim=c("no"))
	out23 <- cal_bs(psmp=smp0[, c("X1", "X2", "X12", "X13", "D", "X1X2", "wght")], nsmp=smp1[, c("X1", "X2", "X12", "X13", "D", "X1X2", "Y2", "wght0")], method=c("PSDO0", "PSDO1", "IPSWC", "IPSW", "OR", "AIPW", "PSPP"), spec=c(F, F), model="GLM", Npop=N, BS=T, nBS=nBS, trim=c("no"))
	#out24 <- cal_bs(psmp=smp0[, c("X1", "X2", "X12", "X13", "D", "X1X2", "wght")], nsmp=smp1[, c("X1", "X2", "X12", "X13", "D", "X1X2", "Y2", "wght0")], method=c("PSDO0", "PSDO1", "IPSWC", "IPSW", "OR", "AIPW", "PSPP"), spec=c(F, F), model="BART", Npop=N, BS=T, nBS=nBS, nMCMC=nMC, trim=c("no"))
	...
	res1[i, paste0("mu", 5:p)] <- c(out10$Mu, out11$Mu, out12$Mu, out13$Mu) #, out14$Mu
	res1[i, paste0("se", 5:p)] <- c(out10$SE, out11$SE, out12$SE, out13$SE) #, out14$SE
	...
	res2[i, paste0("mu", 5:p)] <- c(out20$Mu, out21$Mu, out22$Mu, out23$Mu) #, out24$Mu
	res2[i, paste0("se", 5:p)] <- c(out20$SE, out21$SE, out22$SE, out23$SE) #, out24$SE

	wcor[i, ] <- t(cor(smp1$wght, out10$RW))
	pcor[i, ] <- t(cor(smp1$pi1, 1/out10$RW))
}
...
write.csv(res1, "res1_TT_glm_PSPP_BS200_full.csv", col.names=T, sep=",")
write.csv(res2, "res2_TT_glm_PSPP_BS200_full.csv", col.names=T, sep=",")
...
tb$method <- c("UW_PS", "TW_PS", "UW_NS", "TW_NS", paste(out10$Model, c("TT"), sep="_"), paste(out10$Model, c("TF"), sep="_"), paste(out10$Model, c("FT"), sep="_"), paste(out10$Model, c("FF"), sep="_")) #, paste(out14$Model, c("FF"), sep="_")
...
write.csv(tb, "tb_TT_glm_PSPP_BS200_full.csv", col.names=T, sep=",")

colnames(wcor) <- out10$Model[1:4]
colnames(pcor) <- out10$Model[1:4]
wc <- apply(wcor, 2, function(x)mean(x, na.rm=T))
pc <- apply(pcor, 2, function(x)mean(x, na.rm=T))

write.csv(wc, "wcor_TT_glm_PSPP_BS200_full.csv", col.names=T, sep=",")
write.csv(pc, "pcor_TT_glm_PSPP_BS200_full.csv", col.names=T, sep=",")
